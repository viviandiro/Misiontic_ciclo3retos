...
import co.usa.mintic.actividadReto3.servicios.ClientServicio;
...
@CrossOrigin("*")
public class ControladorClient extends ControladorGenericoAbstracto<Client, Integer> {

    @Autowired
    private ClientServicio servicio;

    @Override
    public ServicioGenericoAbstracto<Client, Integer> getService() {
        return servicio;
    }
